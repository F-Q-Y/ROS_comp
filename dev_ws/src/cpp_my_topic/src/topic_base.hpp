...
void * publisher(void * arg) {
  ...
  w_out_get_loan.open("../ans/ans/"+obj+"_get_loan_writer_"+std::to_string(w)+".out",std::ios::out);
  w_out_publish.open("../ans/ans/"+obj+"_publish_writer_"+std::to_string(w)+".out",std::ios::out);
  w_out.open("../ans/ans/"+obj+"_sum_writer_"+std::to_string(w)+".out",std::ios::out);
  int count = 0;
  while (true) {
