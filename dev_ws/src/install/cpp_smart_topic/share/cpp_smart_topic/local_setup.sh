...
: ${AMENT_CURRENT_PREFIX:="/home/fengqiyuan/dev_ws/src/install/cpp_smart_topic"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_smart_topic/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_smart_topic/environment/path.sh"
