...
plt.plot(x_new,comp_1_smo,color='springgreen',label='mail_proj:N=1')
plt.plot(x_new,comp_3_smo,color='royalblue',label='mail_proj:N=3')
plt.plot(x_new,comp_5_smo,color='yellow',label='mail_proj:N=5')
plt.legend()

plt.xlabel('M')
plt.ylabel('Time consuming for a single pub/s')
plt.savefig("./const_N_mail.png")
plt.show()