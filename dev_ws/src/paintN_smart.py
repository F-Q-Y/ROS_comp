...
plt.plot(x_new,my_1_smo,color='green',label='smart_proj:N=1')
plt.plot(x_new,my_3_smo,color='red',label='smart_proj:N=3')
plt.plot(x_new,my_5_smo,color='blue',label='smart_proj:N=5')
plt.legend()

plt.xlabel('N')
plt.ylabel('Time consuming for a single pub/s')
plt.savefig("./const_N_smart.png")
plt.show()